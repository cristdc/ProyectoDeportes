        ...
        <nav className="bg-white shadow-md">
                            ...
                            {isAuthenticated ? (
                                <div className="flex items-center space-x-4">
                                    <span className="text-[#1a1204] text-sm">
                                        Hola, <Link to="/profile" className='text-gray-500 hover:text-[#8EAC93] hover:font-bold hover:text-lg transition-all duration-150'>{user?.name}</Link>
                                    </span>
                                    <button
            ...
            <div className="hidden md:hidden">
                <div className="px-2 pt-2 pb-3 space-y-1">
                    <Link to="/" className="block px-3 py-2 text-[#1a1204] hover:text-[#8EAC93]">
                        Inicio
                    </Link>
                    <Link to="/carreras-disponibles" className="block px-3 py-2 text-[#1a1204] hover:text-[#8EAC93]">
                        Carreras Disponibles
                    </Link>
                    <Link to="/carreras-historial" className="block px-3 py-2 text-[#1a1204] hover:text-[#8EAC93]">
                        Historial de Carreras
                    </Link>
                </div>
            </div>
