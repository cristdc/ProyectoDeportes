    ...
    return (
      <div className="overflow-x-auto p-4">
        <table className="min-w-full border-collapse border border-gray-300 rounded-lg">
          ...
          <tbody>
            {registrations
              .filter(registration => registration.race.sport.toLowerCase() === "trailrunning")     // para solo coger los de trailrunning
              .map((registration)=>(
                <tr key={registration.race._id} className="text-center">
                  ...
                  <button 
                    ...
                    onClick={() => alert("Has pulsado para desapuntarte")} // esto MAYBE solo para las registradas y NO finlaizadas
                  >
                    Desapuntarse
                  </button>
                  </td>
