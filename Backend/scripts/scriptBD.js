...
// Datos de ejemplo (usando el mismo contenido que en el script anterior)
const exampleData = {
  users: [
    {
      ...
      avatar: "default.jpg",
      age: 35,
      registrationDate: new Date("2023-01-15T10:30:00Z"),
    },
    {
      ...
      avatar: "default.jpg",
      age: 28,
      registrationDate: new Date("2023-02-20T14:45:00Z"),
    },
    {
      ...
      avatar: "default.jpg",
      age: 32,
      registrationDate: new Date("2023-03-05T09:15:00Z"),
    },
  ],
  races: [
    {
      _id: new mongoose.Types.ObjectId("663f1b4667d0d8992e610d85"),
      name: "Maratón Urbano 2023",
      sport: "running",
    ...
    },
    {
      ...
      sport: "trailRunning",
      date: new Date("2023-06-22T07:30:00Z"),
  ...
  registrations: [
    {
      ...
      registeredAt: new Date("2023-03-15T14:30:00Z"),
      status: "registered",
      time: null,
      position: null,
    },
    {
      ...
      user: new mongoose.Types.ObjectId("663f1b4667d0d8992e610c86"),
      registeredAt: new Date("2023-03-16T10:45:00Z"),
      status: "registered",
      time: null,
      position: null,
    },
    {
      ...
      registeredAt: new Date("2023-03-20T11:15:00Z"),
      status: "registered",
      time: null,
      position: null,
    },
