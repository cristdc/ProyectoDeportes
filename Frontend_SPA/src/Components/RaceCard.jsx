      ...
      reader.onload = async (e) => {
        try {
          ...
          try {
            ...
            console.error('Error al actualizar la lista de carreras:', updateError);
          ...
          if (error.message.includes('interno del servidor')) {
            errorMessage = 'Error al procesar el archivo en el servidor. Por favor, verifica que el archivo GPX sea válido.';
          }
