    ...
    <div className="flex flex-col w-full relative">
        ...
        <div className="relative z-10 flex flex-col items-center w-full max-w-3xl mx-auto px-4 sm:px-6 h-full py-4 sm:py-8">
          ...
          <div className="text-center flex flex-col gap-4 flex-grow">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 mt-2 px-2">
              ...
              >
                <h3 className="font-bold text-[1.8vh] sm:text-[2vh] mb-1 sm:mb-2 text-white">Cycling</h3>
                <p className="text-[1.4vh] sm:text-[1.6vh] text-gray-200">Explora rutas desafiantes y paisajes impresionantes sobre dos ruedas.</p>
              ...
              <div 
                ...
                className="bg-black/40 p-3 sm:p-4 rounded-lg cursor-pointer transform hover:scale-105 transition-all duration-300 hover:bg-black/50"
              >
                <h3 className="font-bold text-[1.8vh] sm:text-[2vh] mb-1 sm:mb-2 text-white">Trail Running</h3>
                <p className="text-[1.4vh] sm:text-[1.6vh] text-gray-200">Descubre senderos naturales y supera tus límites corriendo por montañas, bosques y terrenos técnicos.</p>
                <span className="text-[1.2vh] sm:text-[1.4vh] text-white mt-1 block">Click para ver más →</span>
              </div>
              ...
              <div 
                ...
                className="bg-black/40 p-3 sm:p-4 rounded-lg cursor-pointer transform hover:scale-105 transition-all duration-300 hover:bg-black/50"
              >
                <h3 className="font-bold text-[1.8vh] sm:text-[2vh] mb-1 sm:mb-2 text-white">Running</h3>
                <p className="text-[1.4vh] sm:text-[1.6vh] text-gray-200">Participa en carreras urbanas y eventos que combinan la pasión por correr con el espíritu competitivo.</p>
                <span className="text-[1.2vh] sm:text-[1.4vh] text-white mt-1 block">Click para ver más →</span>
              </div>
            </div>
          </div>
      ...
      <div id="cycling" className="w-full relative overflow-hidden flex flex-col lg:flex-row" style={{ minHeight: '100vh' }}>
        <div className="w-full lg:w-1/2 relative" style={{ minHeight: '50vh' }}>
          ...
          <h2 className="absolute bottom-10 left-10 text-3xl sm:text-4xl font-bold text-white">Cycling</h2>
        </div>
        ...
        <div className="w-full lg:w-1/2 bg-[var(--bg-primary)] p-6 sm:p-8 lg:p-16 flex flex-col justify-center">
          <div className="space-y-4 sm:space-y-8">
            ...
            <p className="text-base sm:text-lg text-[var(--text-secondary)] mb-6 sm:mb-10">
              Explora rutas desafiantes y paisajes impresionantes sobre dos ruedas. 
              Desde cicloturismo hasta competiciones de mountain bike.
            </p>
      ...
      <div id="running" className="w-full relative overflow-hidden flex flex-col lg:flex-row-reverse" style={{ minHeight: '100vh' }}>
        <div className="w-full lg:w-1/2 relative" style={{ minHeight: '50vh' }}>
          ...
          <h2 className="absolute bottom-10 right-10 text-3xl sm:text-4xl font-bold text-white">Running</h2>
        </div>
      ...
      <div id="trail" className="w-full relative overflow-hidden flex flex-col lg:flex-row" style={{ minHeight: '100vh' }}>
        <div className="w-full lg:w-1/2 relative" style={{ minHeight: '50vh' }}>
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-black/50 to-transparent" />
          <h2 className="absolute bottom-10 left-10 text-3xl sm:text-4xl font-bold text-white">Trail Running</h2>
        </div>
