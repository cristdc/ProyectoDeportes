...
const Home = () => {
  ...
  const handleDownload = async () => {
    try {
      const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/download/HOLA.exe`);
  ...
  return (
    <div className="flex flex-col w-full">
        ...
        <div className="relative z-10 flex flex-col items-center w-full max-w-3xl mx-auto px-6 h-full py-8">
          ...
          <div className="text-center flex flex-col gap-4 flex-grow">
            ...
            <div className="grid grid-cols-1 gap-4 mt-2">
              ...
              >
                <h3 className="font-bold text-[2vh] mb-2 text-[#9CAF88]">Cycling</h3>
                <p className="text-[1.6vh]">Explora rutas desafiantes y paisajes impresionantes sobre dos ruedas. Desde cicloturismo hasta competiciones de mountain bike.</p>
                <span className="text-[1.4vh] text-[#9CAF88] mt-1 block">Click para ver más →</span>
              </div>
              ...
              <div 
                ...
                className="bg-white/80 p-4 rounded-lg cursor-pointer transform hover:scale-105 transition-all duration-300 hover:bg-white/90"
              >
                <h3 className="font-bold text-[2vh] mb-2 text-[#9CAF88]">Trail Running</h3>
                <p className="text-[1.6vh]">Descubre senderos naturales y supera tus límites corriendo por montañas, bosques y terrenos técnicos.</p>
                <span className="text-[1.4vh] text-[#9CAF88] mt-1 block">Click para ver más →</span>
              </div>
              ...
              <div 
                ...
                className="bg-white/80 p-4 rounded-lg cursor-pointer transform hover:scale-105 transition-all duration-300 hover:bg-white/90"
              >
                <h3 className="font-bold text-[2vh] mb-2 text-[#9CAF88]">Running</h3>
                <p className="text-[1.6vh]">Participa en carreras urbanas y eventos que combinan la pasión por correr con el espíritu competitivo.</p>
                <span className="text-[1.4vh] text-[#9CAF88] mt-1 block">Click para ver más →</span>
              </div>
            </div>
          </div>
      ...
      {/* Sección Cycling */}
      <div id="cycling" className="w-full relative bg-[#D1DCCD] overflow-hidden" style={{ height: '100vh' }}>
        ...
        <div className="absolute inset-0" style={{
          background: 'linear-gradient(45deg, transparent 49.9%, #D1DCCD 50%)'
        }}></div>
      ...
      <div id="running" className="w-full relative bg-[#D1DCCD] overflow-hidden" style={{ height: '100vh' }}>
      ...
      <div id="trail" className="w-full relative bg-[#D1DCCD] overflow-hidden" style={{ height: '100vh' }}>
        <div className="absolute left-0 top-0 w-1/2 h-full">
          <img 
            src={carrera3}
            alt="Carrera 3" 
