    ...
    const fetchRaces = async () => {
      try {
        ...
        setStats({
          ...
          activeRaces:
            data.races?.filter((race) => race.status === "open")?.length || 0,
          totalRunners:
            data.races?.reduce(
              (acc, race) => acc + (race.participants || 0),
              0
            ) || 0,
        });
        setLoading(false);
      ...
      <div className="min-h-screen bg-gradient-to-b from-[#FAF6F1] to-white">
          ...
          >
            <div className="text-center">
              ...
              <p className="text-lg md:text-xl mb-6 md:mb-8 max-w-2xl mx-auto text-white/90 px-4">
                Únete a la comunidad de running más grande y encuentra las
                mejores carreras para desafiarte a ti mismo.
              </p>
            ...
            >
              ...
              >
                <div className="text-center p-4 md:p-8 rounded-2xl bg-gradient-to-br from-white to-[#CCD5AE]/30 shadow-lg border border-[#8D9B6A]/10">
                  <motion.div className="text-3xl md:text-4xl font-bold text-[#8D9B6A] mb-2">
              ...
              >
                <div className="text-center p-4 md:p-8 rounded-2xl bg-gradient-to-br from-white to-[#D4A373]/20 shadow-lg border border-[#D4A373]/10">
                  <motion.div className="text-3xl md:text-4xl font-bold text-[#D4A373] mb-2">
              ...
              >
                <div className="text-center p-4 md:p-8 rounded-2xl bg-gradient-to-br from-white to-[#8D9B6A]/20 shadow-lg border border-[#8D9B6A]/10">
                  <motion.div className="text-3xl md:text-4xl font-bold text-[#5C6744] mb-2">
        ...
        >
          <div className="max-w-7xl mx-auto px-4">
            ...
            >
              <h2 className="text-2xl md:text-3xl font-bold text-[#5C6744] mb-3 md:mb-4">
                Próximas Carreras Destacadas
              </h2>
              <p className="text-sm md:text-base text-gray-600 max-w-2xl mx-auto px-4">
                Descubre las carreras más emocionantes que están por venir y
        ...
        >
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-8 md:mb-12">
              ...
              <p className="text-sm md:text-base text-gray-600 max-w-2xl mx-auto px-4">
                Descubre las ventajas de usar nuestra plataforma para gestionar
                tus carreras
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description:
                    "Todas nuestras rutas están verificadas y medidas con precisión",
                  color: "#8D9B6A",
                  bgColor: "#CCD5AE",
                },
                {
                  ...
                  description:
                    "Monitorea tu progreso y comparte tus logros en tiempo real",
                  color: "#D4A373",
                  bgColor: "#FAEDCD",
                },
                {
                  ...
                  description:
                    "Únete a una comunidad apasionada por el running",
                  color: "#5C6744",
                  bgColor: "#CCD5AE",
                },
              ].map((feature, index) => (
                ...
                >
                  <div className="text-center p-4 md:p-8 rounded-2xl bg-white shadow-lg border border-gray-100">
                    <div
                      ...
                      style={{
                        background: `linear-gradient(135deg, ${feature.bgColor}40, ${feature.bgColor}20)`,
                      }}
                    >
                      <feature.icon
                        className="text-3xl"
                    ...
                    <h3 className="text-xl font-bold text-[#5C6744] mb-3">
                      {feature.title}
                    </h3>
