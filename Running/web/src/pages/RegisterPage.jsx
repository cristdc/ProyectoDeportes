...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showErrorToast(error.message || 'Error al registrar usuario');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-900 px-4">
      <div className="max-w-sm w-full space-y-8 p-6 bg-gray-800 rounded-lg shadow-lg">
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-6">
          <div className="space-y-4">
            ...
            <div>
              <label htmlFor="confirmPassword" className="text-sm text-gray-300">Confirmar Contraseña</label>
              <input
                id="confirmPassword"
